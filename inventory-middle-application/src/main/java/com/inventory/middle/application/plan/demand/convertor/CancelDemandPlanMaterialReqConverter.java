 ...
 */
@Mapper
public interface CancelDemandPlanMaterialReqConverter {

    CancelDemandPlanMaterialReqConverter INSTANCE = Mappers.getMapper(CancelDemandPlanMaterialReqConverter.class);

    CancelDemandPlanMaterialReqBO toBO(CancelDemandPlanMaterialReqDTO source);
