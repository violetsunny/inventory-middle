 ...
 */
@Mapper
public interface DemandPlanMaterialBatchCreateResConverter {

    DemandPlanMaterialBatchCreateResConverter INSTANCE = Mappers.getMapper(DemandPlanMaterialBatchCreateResConverter.class);

    DemandPlanMaterialBatchCreateResDTO toDTO(DemandPlanMaterialBatchCreateResBO source);
