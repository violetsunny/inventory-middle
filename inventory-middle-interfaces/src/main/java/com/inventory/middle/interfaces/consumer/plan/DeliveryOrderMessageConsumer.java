...
@RocketMQMessageListener(
        ...
        consumerGroup = "scm-plan-management-delivery-order-consumer",
        selectorExpression = "deliveryOrderTag"
)
public class DeliveryOrderMessageConsumer implements RocketMQListener<String> {

    @Resource
    private PlanMqConsumerService planMqConsumerService;

    @Override
    @MdcDot(bizCode = "deliveryOrderMq")
    public void onMessage(String message) {
        log.info("DeliveryOrderMessageConsumer.onMessage message={}", message);
        ...
        try {
            ...
            log.error("DeliveryOrderMessageConsumer error", e);
