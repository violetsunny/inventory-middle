...
@RocketMQMessageListener(
        ...
        consumerGroup = "scm-plan-management-plan-demand-consumer",
        selectorExpression = "planDemandSupplyTag"
)
public class PlanDemandMessageConsumer implements RocketMQListener<String> {

    @Resource
    private PlanMqConsumerService planMqConsumerService;

    @Override
    @MdcDot(bizCode = "planDemandMq")
    public void onMessage(String message) {
        log.info("PlanDemandMessageConsumer.onMessage message={}", message);
