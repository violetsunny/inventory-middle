...
@RocketMQMessageListener(
        ...
        consumerGroup = "scm-plan-management-customer-order-consumer",
        selectorExpression = "customerOrderTag"
)
public class CustomerOrderMessageConsumer implements RocketMQListener<String> {

    @Resource
    private PlanMqConsumerService planMqConsumerService;

    @Override
    @MdcDot(bizCode = "customerOrderMq")
    public void onMessage(String message) {
        log.info("CustomerOrderMessageConsumer.onMessage message={}", message);
        ...
        try {
            ...
            log.error("CustomerOrderMessageConsumer error", e);
