...
@RocketMQMessageListener(
        ...
        consumerGroup = "scm-plan-management-purchase-request-consumer",
        selectorExpression = "purchaseRequestTag"
)
public class PurchaseRequestMessageConsumer implements RocketMQListener<String> {

    @Resource
    private PlanMqConsumerService planMqConsumerService;

    @Override
    @MdcDot(bizCode = "purchaseRequestMq")
    public void onMessage(String message) {
        log.info("PurchaseRequestMessageConsumer.onMessage message={}", message);
        ...
        try {
            ...
            log.error("PurchaseRequestMessageConsumer error", e);
