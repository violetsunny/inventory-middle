...
@RocketMQMessageListener(
        ...
        consumerGroup = "scm-plan-management-purchase-order-consumer",
        selectorExpression = "purchaseOrderTag"
)
public class PurchaseOrderMessageConsumer implements RocketMQListener<String> {

    @Resource
    private PlanMqConsumerService planMqConsumerService;

    @Override
    @MdcDot(bizCode = "purchaseOrderMq")
    public void onMessage(String message) {
        log.info("PurchaseOrderMessageConsumer.onMessage message={}", message);
        ...
        try {
            ...
            log.error("PurchaseOrderMessageConsumer error", e);
