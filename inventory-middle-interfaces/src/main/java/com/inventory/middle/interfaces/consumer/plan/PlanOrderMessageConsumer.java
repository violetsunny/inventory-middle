...
@RocketMQMessageListener(
        ...
        consumerGroup = "scm-plan-management-confirm-plan-order-consumer",
        selectorExpression = "confirmPlanOrderTag"
)
public class PlanOrderMessageConsumer implements RocketMQListener<String> {

    @Resource
    private PlanMqConsumerService planMqConsumerService;

    @Override
    @MdcDot(bizCode = "planOrderMq")
    public void onMessage(String message) {
        log.info("PlanOrderMessageConsumer.onMessage message={}", message);
        ...
        try {
            ...
            log.error("PlanOrderMessageConsumer error", e);
