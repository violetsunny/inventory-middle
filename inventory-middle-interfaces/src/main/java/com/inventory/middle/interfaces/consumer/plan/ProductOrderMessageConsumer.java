...
@RocketMQMessageListener(
        ...
        consumerGroup = "scm-plan-management-product-order-consumer",
        selectorExpression = "productOrderTag"
)
public class ProductOrderMessageConsumer implements RocketMQListener<String> {

    @Resource
    private PlanMqConsumerService planMqConsumerService;

    @Override
    @MdcDot(bizCode = "productOrderMq")
    public void onMessage(String message) {
        log.info("ProductOrderMessageConsumer.onMessage message={}", message);
        ...
        try {
            ...
            log.error("ProductOrderMessageConsumer error", e);
