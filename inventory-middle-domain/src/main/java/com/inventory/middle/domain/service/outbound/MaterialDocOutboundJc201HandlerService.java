...
/**
 * @author holmes
 * @Classname MaterialDocOutboundJc201HandlerService
 * @Description 借出领用
 * @Date 2021/8/27 19:48
 */
@Slf4j
@Service
public class MaterialDocOutboundJc201HandlerService extends MaterialDocOutboundDefaultHandlerService {
