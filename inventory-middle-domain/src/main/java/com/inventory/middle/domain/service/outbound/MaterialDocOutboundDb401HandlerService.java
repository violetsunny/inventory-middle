...
/**
 * @author holmes
 * @Classname MaterialDocOutboundDb401HandlerService
 * @Description 跨公司调拨-出库  DB401
 * @Date 2021/10/20 11:24
 */
@Slf4j
@Service
public class MaterialDocOutboundDb401HandlerService extends MaterialDocOutboundDefaultHandlerService {
    ...
    public void doOutbound(MaterialDocumentBO materialDocumentBO) {
        ...
        //check param
        checkDbParam(materialDocumentBO);
        //move out
        generateDemandData(materialDocumentBO, false);
        //generate stock (on the way)
        generateTransitStock(materialDocumentBO);
