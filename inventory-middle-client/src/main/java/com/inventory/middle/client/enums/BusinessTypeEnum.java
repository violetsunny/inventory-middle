...
public enum BusinessTypeEnum {
    ...
    GIVEAWAY_BACK("GIVEAWAY_BACK", "赠品退货", MaterialAdjustTypeEnum.OZP721, MaterialDocCategoryEnum.OUT, "-",
            Arrays.asList(MaterialDocSourceEnum.IMP, MaterialDocSourceEnum.INTERFACE)),
    GIVEAWAY_BACK_CANCEL("GIVEAWAY_BACK_CANCEL", "赠品退货-撤销", MaterialAdjustTypeEnum.OZP722, MaterialDocCategoryEnum.CANCEL, "+",
            Arrays.asList(MaterialDocSourceEnum.IMP, MaterialDocSourceEnum.INTERFACE)),
    ...
    PURCHASE_RETURN("PURCHASE_RETURN", "采购退供出库", MaterialAdjustTypeEnum.CG121, MaterialDocCategoryEnum.OUT, "-",
            Arrays.asList(MaterialDocSourceEnum.IMP, MaterialDocSourceEnum.INTERFACE)),
    PURCHASE_RETURN_CANCEL("PURCHASE_RETURN_CANCEL", "采购退供出库-撤销", MaterialAdjustTypeEnum.CG122, MaterialDocCategoryEnum.CANCEL, "+",
            Arrays.asList(MaterialDocSourceEnum.IMP, MaterialDocSourceEnum.INTERFACE)),
    ...
    PICKING_BACK("PICKING_BACK", "物料领用退库", MaterialAdjustTypeEnum.OLY221, MaterialDocCategoryEnum.IN, "+",
            Arrays.asList(MaterialDocSourceEnum.IMP, MaterialDocSourceEnum.INTERFACE)),
    PICKING_BACK_CANCEL("PICKING_BACK_CANCEL", "物料领用退库-撤销", MaterialAdjustTypeEnum.OLY222, MaterialDocCategoryEnum.CANCEL, "-",
            Arrays.asList(MaterialDocSourceEnum.IMP, MaterialDocSourceEnum.INTERFACE)),
